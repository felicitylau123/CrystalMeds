...
builder.Services.AddHttpClient("CrystalMeds.ServerAPI", (sp,client) => {client.BaseAddress = new Uri(builder.HostEnvironment.BaseAddress);client.EnableIntercept(sp);
})
